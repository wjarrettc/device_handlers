...
metadata {
	definition (name: "SmartSense Multi Sensor (Acceleration Main Tile)", namespace: "smartthings", author: "SmartThings") {
	...
	tiles(scale: 1) {
		multiAttributeTile(name:"status", type: "generic", width: 6, height: 4){
			tileAttribute ("device.acceleration", key: "PRIMARY_CONTROL") {
                attributeState "active", label:'Active', icon:"st.motion.acceleration.active", backgroundColor:"#53a7c0"
			    attributeState "inactive", label:'Inactive', icon:"st.motion.acceleration.inactive", backgroundColor:"#ffffff"
			}
		}
